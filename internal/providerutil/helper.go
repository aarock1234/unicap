// Package providerutil contains shared provider implementation helpers that
// are intentionally kept out of the public SDK surface.
...
// HTTPClient provides common HTTP functionality for provider implementations.
...
func (c *HTTPClient) DoJSON(ctx context.Context, endpoint string, reqBody, respBody any) error {
